...
Una dificultad añadida es que se ha visto que un mismo varemos no es válido para toda la población mundial, habiendose encontrado que para las distintas etnias, deben considerarse valores de corte diferentes a la hora de realizar un diagnóstico.
